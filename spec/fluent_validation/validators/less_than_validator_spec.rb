...
RSpec.describe FluentValidation::Validators::LessThanValidator  do
  before(:each) do
    @validator = FluentValidation::Validators::LessThanValidator.new(5)
  end
  ...
  it 'should return success when given correct value' do
    context = FluentValidation::Validators::AttributeValidatorContext.new('Scale', 4)
    validation_failures = @validator.validate(context)
